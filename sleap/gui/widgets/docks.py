...
class SessionsDock(DockWidget):
    def __init__(
        ...
        self.camera_categories_model_type = CameraCategoriesTableModel
        super().__init__(
            name="Sessions",
            main_window=main_window,
            model_type=[
                ...
                self.camera_categories_model_type,
            ],
            tab_with=tab_with,
        )
    ...
    def create_models(self) -> Union[GenericTableModel, Dict[str, GenericTableModel]]:
        ...
        self.model = {
            ...
            "camera_categories_model": self.camera_categories_model,
        }
        return self.model
    ...
    def create_tables(self) -> Union[GenericTableView, Dict[str, GenericTableView]]:
        ...
        self.table = {
            ...
            "camera_categories_table": self.camera_categories_table,
        }
        return self.table
