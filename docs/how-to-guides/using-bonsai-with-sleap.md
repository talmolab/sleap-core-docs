...
```
Please refer to the [`sleap-export`](../reference/command-line-interfaces.md/#sleap-export) docs for more details on using the command.
...
![Bonsai FileCapture module](../assets/images/bonsai-filecapture.jpg)
...
![Bonsai PredictCentroids module](../assets/images/bonsai-predictcentroids.jpg)
...
![Bonsai PredictPoses module](../assets/images/bonsai-predictposes.jpg)
...
![Bonsai PredictPoseIdentities module](../assets/images/bonsai-predictposeidentities.jpg)
...
![Bonsai module connection](../assets/images/bonsai-connection.jpg)

Once it is done, the workflow in Bonsai will look something like the following:

![Bonsai.SLEAP workflow](../assets/images/bonsai-workflow.jpg)
